...
<div id="app" class="overflow-hidden background-logo" data-v-app="" style="height: 100%">
    <div class="home-ui">
        <a href="index.php" class="top-0 z-10 left-0 right-0 flex flex-col justify-center items-center text-white py-5 aos-init aos-animate" data-aos="fade-down">
